    ...
    return (
        <DefaultLayout >
            ...
            <Box px={10} py={10} pt={10} pb={10}  >
                ...
                {/* 一列目 */}
                <Flex justify="space-around" align="stretch" direction={{ base: "column-reverse", md: "row" }}>
                    {/* 左の要素について */}
                    <Box bg="#FFFFFE"  h={325}
                        borderRadius={br}>
                        ...
                        <Flex align="center" direction='column' justify="space-around">
                            <Flex>
                                <Text fontSize={ranktext} color={pink}>段位:</Text>
                ...
                <Flex justify="space-around" align="center" mt={8}>
                    <Box bg="#0D0D0D" minW={bigwidth} minH={200}
                        borderRadius={br}>

                    </Box>

                    <Box bg="#FFFFFE"  h={200} ml={5}
                        borderRadius={br}>
